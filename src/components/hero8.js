              ...
              {props.heading1 ?? (
                <Fragment>
                  <span className="hero8-text5">
                    Welcome to Tony Montana Fitness
                  </span>
                </Fragment>
              )}
            </h1>
              ...
              {props.content1 ?? (
                <Fragment>
                  <span className="hero8-text7">
                    Achieve Your Fitness Goals with Tony Montana Fitness
                  </span>
                </Fragment>
              )}
            </p>
            <div className="hero8-actions">
              ...
              <button className="thq-button-outline hero8-button2">
                <span className="thq-body-small">
                  {props.action2 ?? (
                    <Fragment>
                      <span className="hero8-text6">Get Started</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Hero8.defaultProps = {
  heading1: undefined,
  image1Src:
    'https://images.unsplash.com/photo-1511174511562-5f7f18b874f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTUzNDg4MXw&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'Personalized Fitness Plans',
  action2: undefined,
  content1: undefined,
  action1: undefined,
}
