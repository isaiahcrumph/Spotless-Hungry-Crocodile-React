              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text18">Subscribe</span>
                      </Fragment>
                    )}
                  </span>
                </button>
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text22">Contact</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                  ...
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer1-text25">
                        mailto:info@tonymontanafitness.com
                      </span>
                    </Fragment>
                  )}
                </a>
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer1-text13">tel:123-456-7890</span>
                    </Fragment>
                  )}
                </a>
                <a
                  ...
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer1-text17">
                        https://www.facebook.com/tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer1-text15">
                        https://www.instagram.com/tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text23">
                        https://www.twitter.com/tonymontanafit
                      </span>
                    </Fragment>
                  )}
                </a>
            ...
            <div className="footer1-column2">
              <strong className="thq-body-large footer1-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer1-text10">Follow Us</span>
                  </Fragment>
                )}
              </strong>
                  ...
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer1-text27">
                        https://www.youtube.com/tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text19">
                        https://www.pinterest.com/tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer1-text28">
                        https://www.linkedin.com/in/tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text24">
                        https://www.snapchat.com/add/tonymontanafit
                      </span>
                    </Fragment>
                  )}
                </a>
                  ...
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text16">
                        https://www.tiktok.com/@tonymontanafitness
                      </span>
                    </Fragment>
                  )}
                </a>
            ...
            <div className="footer1-column3">
              <strong className="thq-body-large footer1-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer1-text26">Social Media</span>
                  </Fragment>
                )}
              </strong>
        ...
        <div className="footer1-credits">
          ...
          <div className="footer1-row">
            <span className="thq-body-small">
              {props.content3 ?? (
                <Fragment>
                  <span className="footer1-text12">© 2024 TeleportHQ</span>
                </Fragment>
              )}
            </span>
            <div className="footer1-footer-links3">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer1-text20">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer1-text21">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text14">Cookies Settings</span>
                  </Fragment>
                )}
              </span>
            </div>
