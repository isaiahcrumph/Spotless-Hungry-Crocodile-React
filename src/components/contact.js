...
Contact.defaultProps = {
  address1: '123 Fitness Street, Miami, FL',
  content1:
    'Feel free to reach out to Tony Montana for any fitness consultation or inquiries.',
  content2: 'You can also fill out the form below to send a message directly.',
  content3:
    'Tony Montana is dedicated to helping you achieve your fitness goals.',
  content4: 'Get in touch today and start your fitness journey with Tony!',
  heading1: 'Contact Tony Montana',
  phone1: '+1-555-123-4567',
  email1: 'tony@montanafitness.com',
  content5: 'Follow Tony on social media for fitness tips and updates.',
}
