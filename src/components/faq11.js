                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="faq11-text28">
                      Tony Montana Fitness offers personalized workout plans,
                      nutrition guidance, and fitness consultations to help
                  ...
                  {props.faq1Question ?? (
                    <Fragment>
                      <span className="faq11-text19">
                        What services does Tony Montana Fitness offer?
                      </span>
                    </Fragment>
                  )}
                </p>
            ...
            <div className="faq11-faq2">
              ...
              >
                <p className="faq11-faq2-question1 thq-body-large">
                  {props.faq2Question ?? (
                    <Fragment>
                      <span className="faq11-text20">Who is Tony Montana?</span>
                    </Fragment>
                  )}
                </p>
                  ...
                  {props.faq3Question ?? (
                    <Fragment>
                      <span className="faq11-text25">
                        How can I start my fitness journey with Tony Montana
                        Fitness?
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.faq4Question ?? (
                    <Fragment>
                      <span className="faq11-text24">
                        Are the workout plans and nutrition guidance
                        personalized?
                      </span>
                    </Fragment>
                  )}
        ...
        <div className="faq11-content2 thq-flex-column">
          <div className="faq11-content3">
            <h2 className="faq11-text17 thq-heading-2">
              {props.heading2 ?? (
                <Fragment>
                  <span className="faq11-text23">Still have a question?</span>
                </Fragment>
              )}
            </h2>
              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="faq11-text22">
                    Tony Montana is a renowned fitness consultant who provides
                    expert guidance and tailored programs to transform your
                    body.
                  </span>
                </Fragment>
              )}
          ...
          <button className="thq-button-filled">
            <span className="thq-body-small">
              {props.action ?? (
                <Fragment>
                  <span className="faq11-text27">Contact</span>
                </Fragment>
              )}
            </span>
          </button>
