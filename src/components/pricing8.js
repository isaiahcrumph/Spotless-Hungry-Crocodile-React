      ...
      <div className="pricing8-max-width thq-section-max-width">
        <div className="pricing8-section-title">
          <span className="pricing8-text100 thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="pricing8-text164">Pricing plans</span>
              </Fragment>
            )}
          </span>
          <div className="pricing8-content">
            ...
            <p className="pricing8-text102 thq-body-large">
              {props.content2 ?? (
                <Fragment>
                  <span className="pricing8-text182">
        ...
        <div className="pricing8-tabs">
          {isMonthly && (
            <button
              ...
              className="pricing8-button10 thq-button-animated thq-button-filled"
            >
          ...
          {!isMonthly && (
            <button
              ...
              className="pricing8-button12 thq-button-animated thq-button-filled"
            >
        ...
        {isMonthly && (
          <div className="pricing8-container1">
            <div className="pricing8-column1 thq-card">
              ...
              <div className="pricing8-price10">
                <div className="pricing8-price11">
                  <p className="pricing8-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing8-text195">Basic Plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing8-text184">$50/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text203">$500/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing8-list1">
                  ...
                  <div className="pricing8-list-item12">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing8-text199">
              ...
              <button
                type="button"
                className="pricing8-button14 thq-button-animated thq-button-outline"
              >
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing8-text158">Sign up now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column2 thq-card">
              ...
              <div className="pricing8-price12">
                <div className="pricing8-price13">
                  <p className="pricing8-text114 thq-body-large">
                    {props.plan2 ?? (
                      <Fragment>
                        <span className="pricing8-text159">Business plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing8-text178">$29/mo</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text179">or $299 yearly</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing8-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing8-text193">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column3 thq-card">
              ...
              <div className="pricing8-price14">
                <div className="pricing8-price15">
                  <p className="pricing8-text122 thq-body-large">
                    {props.plan3 ?? (
                      <Fragment>
                  ...
                  <h3 className="pricing8-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing8-text187">$49/mo</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text201">or $499 yearly</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing8-list3">
                  ...
                  <div className="pricing8-list-item18">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing8-text185">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item19">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature3 ?? (
                        <Fragment>
                          <span className="pricing8-text180">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item21">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature5 ?? (
                        <Fragment>
                          <span className="pricing8-text190">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button16 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing8-text204">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column4 thq-card">
              ...
              <div className="pricing8-price16">
                <div className="pricing8-price17">
                  <span className="pricing8-text131 thq-body-large">
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing8-text168">Basic plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing8-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text191">$200/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text174">or $20 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing8-list-item22">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature11 ?? (
                        <Fragment>
                          <span className="pricing8-text192">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button17 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text183">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column5 thq-card">
              ...
              <div className="pricing8-price18">
                <div className="pricing8-price19">
                  <span className="pricing8-text138 thq-body-large">
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing8-text200">Business plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing8-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text175">$299/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text202">or $29 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing8-list-item25">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature11 ?? (
                        <Fragment>
                          <span className="pricing8-text165">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item26">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature21 ?? (
                        <Fragment>
                          <span className="pricing8-text163">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button18 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text170">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column6 thq-card">
              ...
              <div className="pricing8-price20">
                <div className="pricing8-price21">
                  <span className="pricing8-text146 thq-body-large">
                    {props.plan31 ?? (
                      <Fragment>
                  ...
                  <h3 className="pricing8-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text172">$499/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text160">or $49 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing8-list-item29">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature11 ?? (
                        <Fragment>
                          <span className="pricing8-text162">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item30">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature21 ?? (
                        <Fragment>
                          <span className="pricing8-text181">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="pricing8-list-item31">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature31 ?? (
                        <Fragment>
                          <span className="pricing8-text157">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button19 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action1 ?? (
                    <Fragment>
