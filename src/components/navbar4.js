        ...
        <div data-thq="thq-navbar-nav" className="navbar4-desktop-menu">
          <nav className="navbar4-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar4-text5">About</span>
                </Fragment>
              )}
            </a>
            ...
            <a href={props.link4Url} className="thq-link thq-body-small">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar4-text6">Testimonials</span>
                </Fragment>
              )}
            </a>
            <a href={props.link5Url} className="thq-link thq-body-small">
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar4-text9">Contact</span>
                </Fragment>
              )}
            </a>
          </nav>
          <div className="navbar4-buttons1">
            <button className="navbar4-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar4-text4">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar4-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
